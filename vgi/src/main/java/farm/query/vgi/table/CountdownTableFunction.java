...
public abstract class CountdownTableFunction extends SimpleTableFunction {
     ...
     *
     * @return the extra argument specs; empty by default
     */
    protected List<ArgSpec> extraArgs() { return List.of(); }

    /** {@return the {@code count} positional plus {@code batch_size} named arg and any {@link #extraArgs() extras}} */
    @Override
    ...
    /** {@return the {@code count} positional argument as the row estimate, or {@code -1} when absent} */
    @Override
     ...
     * @return single-column min/max statistics, or {@code null} when inapplicable
     */
    @Override
