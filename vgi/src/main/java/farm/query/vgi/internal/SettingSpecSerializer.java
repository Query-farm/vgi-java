...
public final class SettingSpecSerializer {
    ...
    /**
     * Serialise {@code spec} to the 1-row IPC stream DuckDB expects for a session setting.
     *
     * @param spec the setting to encode, including its Arrow type and optional default value
