...
public final class CatalogInfoSerializer {
    ...
    /**
     * Serialise a CatalogInfo discovery record to its one-row IPC wire bytes.
     *
     * @param name                  catalog name (non-null wire field)
     * @param implementationVersion worker implementation version, or {@code null}
     * @param dataVersionSpec       supported data-version range spec, or {@code null}
     * @param attachOptions         IPC-encoded attach option specs, or {@code null}
     * @param releases              data-version release manifest, or {@code null}
     * @param sourceUrl             catalog source URL, or {@code null}
