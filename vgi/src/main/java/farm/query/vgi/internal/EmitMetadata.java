...
public final class EmitMetadata {
     ...
     *
     * @param min the column minimum over the batch
     * @param max the column maximum over the batch
     */
     ...
     * @param type the field's Arrow type
     * @return a field carrying the {@link #PARTITION_COLUMN_KEY} metadata flag
     */
     ...
     *
     * @param index the batch's partition index
     * @return a single-entry {@code vgi_batch_index} metadata map
     */
