...
public final class CfdoStorage implements FunctionStorage {
    ...
    /** Thrown on a non-2xx response from the Worker. */
    ...
    /** Build from {@code VGI_CF_DO_URL} / {@code VGI_CF_DO_TOKEN}. */
    ...
    /** A view pinned to one shard key (att-&lt;hex uuid&gt;), routing per logical ATTACH. */
